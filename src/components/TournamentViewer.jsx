  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-4 sm:p-6 flex items-center justify-between">
          <div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {/* Champion */}
          {champion && (
            <div className="bg-gradient-to-r from-yellow-50 via-orange-50 to-red-50 border-2 border-yellow-300 rounded-xl p-4 sm:p-6 mb-6 text-center">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {teams.map((team, idx) => (
                <div key={idx} className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-3">
            ...
            <div>
              ...
              <div className="space-y-3">
                {bracketMatches.map((match, idx) => {
                  ...
                  return (
                    <div key={idx} className="bg-white border-2 border-gray-200 rounded-xl p-3 sm:p-4">
