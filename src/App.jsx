...
import CoreMemberDetails from "./pages/CoreMembersDetails"; // Import CoreMemberDetails page
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/core-member/:id" element={<CoreMemberDetails />} /> {/* ✅ New Route for Core Member Details */}
