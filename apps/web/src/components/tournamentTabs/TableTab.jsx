...
const TableTab = ({
  ...
  return (
    <MotionSection
      ...
      animate="animate"
      exit="exit"
      className={`variant-a-card variant-a-table-shell ${sportId === 'boxCricket' ? 'variant-a-table-shell-cricket' : ''}`.trim()}
    >
      ...
      <LayoutGroup id="points-table-layout">
        <div className="variant-a-table-card">
          <div className="variant-a-table-header">
            ...
            <span>MP</span>
            <span>Pts</span>
            {sportId === 'boxCricket' && <span>NRR</span>}
          </div>
          ...
          {pointsTable.map((team, index) => {
            ...
            return (
              ...
              >
                ...
                {sportId === 'boxCricket' && (
                  <span className="variant-a-cell-center">
                    {Number.isFinite(Number(team.netRunRate))
